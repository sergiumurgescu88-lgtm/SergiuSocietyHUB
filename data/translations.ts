...
export const translations: Record<Language, Translation> = {
  ...
  es: {
    ...
    footerText: "62 proyectos digitales · Restaurantes, IA, Energía, Marketing, Estilo de vida y más",
  ...
  fr: {
    ...
    freeAccessSubtitle: "Débloquez instantanément les 62 fonctions premium en rejoignant notre newsletter.",
    ...
    footerText: "62 projets numériques · Restaurants, IA, Énergie, Marketing, Lifestyle & plus",
    ...
    successSubscribe: "Bienvenue ! Vous avez maintenant un accès complet aux 62 fonctions.",
    ...
    wildBotBehaviorBadge: "Moteur de Comportamiento Humain",
  ...
  it: {
    ...
    freeAccessSubtitle: "Sblocca istantaneamente tutte le 62 funzioni premium iscrivendoti alla nostra newsletter.",
    ...
    statsTotalDesc: "Ho raccolto aici tutto ciò che ho costruito: dai robot intelligenti che aiutano i ristoranti a funzionare meglio, ai sistemi di energia solare e agli strumenti che ti aiutano a essere più creativo. Tutto è progettato per essere semplice, utile e portare un tocco di magia nella vita di tutti i giorni.",
    ...
    footerText: "62 progetti digitali · Ristoranti, IA, Energia, Marketing, Lifestyle e altro",
  ...
  de: {
    ...
    freeAccessSubtitle: "Schalten Sie sofort alle 62 Premium-Funktionen frei, indem Sie unseren Newsletter abonnieren.",
    ...
    footerText: "62 digitale Projekte · Restaurants, KI, Energie, Marketing, Lifestyle & mehr",
  ...
  ar: {
    ...
    freeAccessSubtitle: "افتح جميع الوظائف المميزة الـ 62 فوراً من خلال الانضمام إلى نشرتنا الإخبارية.",
    ...
    footerText: "62 مشروعاً رقمياً · مطاعم، ذكاء اصطناعي، طاقة، تسويق، أسلوب حياة وأكثر",
    footerClick: "انقر على أي بطاقة لزيارة المشروع مباشرة!",
    footerPassion: "بني بشغف وذكاء اصطناعي — 2026",
    successSubscribe: "أهلاً بك! لديك الآن وصول كامل إلى جميع الوظائف الـ 62.",
    ...
    wildBotStatSubscription: "اشتrak شهري",
